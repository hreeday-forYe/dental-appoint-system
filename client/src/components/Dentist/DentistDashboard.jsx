...
import { useCancelAppointmentMutation, useGetDentistAppointmentsQuery } from "@/app/slices/appointmentApiSlice";
...
// function AppointmentCard({ appointment, onConfirm, onReject }) {
...
export default function DentistDashboard() {
  ...
  const onReject = async (id) =>{
    try {
      const response = await cancelAppointment({appointmentId:id, reason: "Dentist canceled the appointment"}).unwrap()
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              ...
              {/* TODO: INTEGRATE CALENDER VIEW FOR THE DENTIST APPOINTMENTS */}
            </div>
          </div>
