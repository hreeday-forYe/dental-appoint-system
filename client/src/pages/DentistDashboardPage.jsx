...
// import React from 'react';
import { Home, ClipboardList, HeartPulse, Bluetooth as Tooth,  PhoneCall } from 'lucide-react';
...
function Sidebar({ userRole = 'admin', userName, userTitle }) {
  ...
  const menuItems = {
    ...
    dentist: [
      ...
      { icon: ClipboardList, label: 'Treatment Plans', path: '/dentist/treatments' },
      { icon: DollarSign, label: 'Billing', path: '/dentist/billing' },
      { icon: User, label: 'Profile', path: '/profile' },
    ]
  };

  const currentMenuItems = menuItems[userRole === 'admin' ? 'admin' : 'dentist'];
      ...
      <main className="flex-1 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-3xl font-bold text-blue-600">Dr. Patrick Kim</h2>
          ...
          <div className="grid grid-cols-6 gap-6">
            {[
              { icon: Calendar, label: 'Appointments', value: '639' },
            ].map((stat, index) => (
    ...
    <div className="bg-white p-6 rounded-xl shadow-sm">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <span className={`text-sm ${change.value >= 0 ? 'text-green-500' : 'text-red-500'}`}>
